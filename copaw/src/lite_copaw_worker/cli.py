"""CLI entry point: lite-copaw-worker

Lightweight variant of copaw-worker that runs headless (no web console)
and is designed for the lite CoPaw runtime.
"""
...
from lite_copaw_worker.worker import LiteWorker
...
def main() -> None:
    ...
    def _run(
        ...
        """Start the lite CoPaw Worker and connect to Matrix."""
        config = WorkerConfig(
            worker_name=name,
            minio_endpoint=fs,
